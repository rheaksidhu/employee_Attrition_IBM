...
corrChartPath = 'v4a_Sonnet_initial_correlation_chart.png'
...
#extract the best XGBoost model refit on the full training set using the best parameters; this is used for both evaluation and SHAP explanation
bestXgbModel = randomSearch.best_estimator_

#-----------------------------------------------------------------------
#SECTION 4: EVALUATION ON HELD-OUT TEST SET
#test set is evaluated here for the first time; it has never been seen by RandomizedSearchCV or the preprocessor fit step
#-----------------------------------------------------------------------
...
#apply both thresholds to enable a comparison table; 0.5 is the conventional default and 0.3 is the operationally preferred threshold that maximises recall at the cost of some precision
...
print(f"\n{'Metric':<25} {'Threshold 0.5':>15} {'Threshold 0.3':>15}")
print("-" * 57)
print(f"{'Precision (positive)':<25} {testPrecisionAt05:>15.4f} {testPrecisionAt03:>15.4f}")
print(f"{'Recall (positive)':<25} {testRecallAt05:>15.4f} {testRecallAt03:>15.4f}")
print(f"{'F1-Score (positive)':<25} {testF1at05:>15.4f} {testF1at03:>15.4f}")
...
cmPlotPath = 'v4a_Sonnet_initial_confusion_matrix.png'
...
shapImportancePath = 'v4a_Sonnet_initial_shap_importance.png'
...
fairnessPlotPath = 'v4a_Sonnet_initial_fairness_audit.png'
