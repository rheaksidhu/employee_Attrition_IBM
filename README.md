# V3 Random Forest — SHAP Explanations & Threshold Tuning
...
- V3 final (85/15, RandomizedSearchCV): AUC-ROC 0.794, Recall 41.7% — confirming bottleneck was algorithmic not data volume
